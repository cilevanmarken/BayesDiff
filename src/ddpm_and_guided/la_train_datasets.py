...
class celeba_dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, args, config):
        ...
        self.config = config
        self.args = args
        self.folder = "/home/scur0387/BayesDiff/ddpm_and_guided/datasets/"
        cx = 89
        cy = 121
        x1 = cy - 64
        x2 = cy + 64
    ...
    def __getitem__(self, index):
        ...
        x = PIL.Image.open(os.path.join(self.folder, "img_align_celeba", self.filename[index]))
        x = self.transform(x)
...
class imagenet_dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, args, config):
        ...
        super().__init__()
        self.image_path = "/home/scur0387/BayesDiff/ddpm_and_guided/datasets/imagenet/val"
