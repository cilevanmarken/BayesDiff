...
5) For the test data on CelebA, we have selected all the images with a basecount higher than 180000 and put them in a separate folder for evaluation. You can put the images in /src/test_data/images/
